...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    // site description
    description: 'A space where I discuss technology, linguistics and whatever else I think is worth sharing :)',
  ...
  footer: {
    ...
    links: [
      ...
      {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/ajwad-mahboob/',
      },
      {
        name: 'GitHub',
        url: 'https://github.com/rtsajwad',
      },
      {
        name: 'Email',
        url: 'ajwadjs@outlook.com',
      },
      // {
      //   name: 'X',
